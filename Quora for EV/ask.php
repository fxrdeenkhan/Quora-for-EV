...
<html>
    ...
    <body id="ask">
            ...
            <div id="sf">
                <center>
                    ...
                    <form action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <input name="cat" value="abc" type="hidden">
        ...
        <div id="ask-ta">
            <span style="color:white; background-color:black; opacity:0.8; border-radius:50px 50px; font-size:2em !important; padding:5px; display:inline !important;">Thankyou Stay tunned for updates.</span>
        </div>
